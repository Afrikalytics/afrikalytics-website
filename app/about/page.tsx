      ...
      <section className="bg-gradient-to-br from-primary-700 to-primary-900 text-white py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            À Propos de Datatym AI by Marketym
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-gray-600 leading-relaxed">
              Datatym AI by Marketym démocratise l&apos;accès à l&apos;intelligence d&apos;affaires de haute qualité 
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none text-gray-600">
            <p className="mb-4">
              Fondée en 2023 à Dakar, Sénégal, Datatym AI by Marketym est née d&apos;une conviction simple : 
